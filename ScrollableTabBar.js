...
import Button from '../../../node_modules/react-native-scrollable-tab-view/Button';
      ...
      <Button
        ...
        <View
          style={[
            styles.tab,
            this.props.tabStyle,
            {minWidth: WINDOW_WIDTH / this.props.tabs.length},
          ]}>
        ...
        <ScrollView
          ...
          <View
            ...
            <Animated.View style={[tabUnderlineStyle, dynamicTabUnderline]}>
              <View style={[this.props.underlineStyle, {width: 45}]} />
            </Animated.View>
          </View>
        </ScrollView>
      </View>
